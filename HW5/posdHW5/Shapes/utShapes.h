...
//------------------------------------------------HW5---------------------------------------------------
TEST(Problem1,MyDocument)
{
    MyDocument md;
    try
    {
        CHECK(string("combo(r(0 0 3 2) c(0 0 5) combo(r(0 0 5 4) c(0 0 10) )combo(r(0 1 8 7) c(0 1 10) ))")==md.openDocument("myShape.txt"));
    }catch(string s)
    {
        cout<<s<<endl;
    }
